...
public class FConstants {
    static {
        ...
        FollowerConstants.translationalPIDFCoefficients = new CustomPIDFCoefficients(0.1,0,0,0);
        ...
        FollowerConstants.headingPIDFCoefficients = new CustomPIDFCoefficients(3,0,0.02,0);
        ...
        FollowerConstants.drivePIDFCoefficients = new CustomFilteredPIDFCoefficients(0.1,0.000001,0.002,0.6,0);
